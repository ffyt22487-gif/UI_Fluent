...
local Themes = {
	...
	Dark = {
		...
		DialogInputLine = Color3.fromRGB(210, 210, 210),
	...
	Cloud = {
		...
		DialogInputLine = Color3.fromRGB(70, 120, 130),
		Text = Color3.fromRGB(185, 215, 208),
		SubText = Color3.fromRGB(145, 145, 145),
		Hover = Color3.fromRGB(112, 155, 160),
		HoverChange = 0.04,
	},
	Grape = {
		...
		DialogInputLine = Color3.fromRGB(60, 60, 60),
		Text = Color3.fromRGB(220, 220, 220),
		SubText = Color3.fromRGB(100, 120, 145),
		Hover = Color3.fromRGB(40, 40, 40),
		HoverChange = 0.04
	},
	Bloody = {
	...
	return function(Config)
		...
		TitleBar.Frame = New("Frame", {
			...
			New("Frame", {
				...
				New("ImageLabel", {
					Image = "rbxassetid://99118312841228",
					Size = UDim2.fromOffset(20, 20),
					BackgroundTransparency = 1,
					LayoutOrder = 0,
...
Components.Window = (function()
	...
	return function(Config)
		...
		local ImageAsset = Config.Image or "rbxassetid://99118312841228"
